...
from .outputs import ConversationReply, ProviderConversationReplyV2, adapt_provider_reply_v2
...
DESIGN_CONVERSATION_DEFINITION = AgentDefinition(
    ...
    provider_output_model=ProviderConversationReplyV2,
    provider_output_adapter=adapt_provider_reply_v2,
)
